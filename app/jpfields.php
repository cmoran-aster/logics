...
<?php
		...
		class Campo { 
			...
			public function desplegar() { 
				require $_SESSION['IncludePath'] . "db_connect.php";
				...
				switch ($this->Tipo) {
					...
					case "comboq":
						...
						$html .= '<option value="-5">Otros</option>';
					...
					case "comboPicker":
						...
						$html = "<select class=\"form-control form-control-sm select2bs4\" id=\"{$this->Nombre}\"";
						...
						$html .= ">";
						$html .= '<option value="-1" SELECTED>' . htmlentities('Todo')."</option>\r\n";
						if ($this->Otros > 0) {
							$html .= '<option value="-5">Otros</option>';
						}
